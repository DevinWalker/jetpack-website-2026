...
export interface AnimatedListProps {
  ...
  className?: string;
  /** Override the default card styling on each item wrapper */
...
const AnimatedListItemComponent: React.FC<{
  ...
  return (
    <motion.div
      ref={itemRef}
      className={cn(
        itemClassName ?? "relative overflow-hidden rounded-2xl bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-neutral-800",
